...
public class votemain3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_votemain3);
        RG = findViewById(R.id.algogrp);
        algo = findViewById(R.id.algovote);
    ...
    public void onClick(View v) {
        ...
        //Toast.makeText(votemain3.this,"Voted for :"+RB.getText(),Toast.LENGTH_LONG).show();
