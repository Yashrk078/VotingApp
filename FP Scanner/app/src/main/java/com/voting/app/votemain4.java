...
public class votemain4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_votemain4);

        RG = findViewById(R.id.gamegrp);
         game = findViewById(R.id.gamevote);
    ...
    public void onClick(View v) {
        ...
        //Toast.makeText(votemain4.this,"Voted for :"+RB.getText(),Toast.LENGTH_LONG).show();
    ...
    private BiometricPrompt getprompt(){
        ...
        BiometricPrompt.AuthenticationCallback callback = new BiometricPrompt.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded(@NonNull @NotNull BiometricPrompt.AuthenticationResult result) {
                ...
                vote.put("Category","Developer Team");
