...
public class votemain5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_votemain5);

        RG = findViewById(R.id.foodgrp);
        food = findViewById(R.id.foodvote);
    ...
    public void onClick(View v) {
       ...
       // Toast.makeText(votemain5.this,"Voted for :"+RB.getText(),Toast.LENGTH_LONG).show();
    ...
    private BiometricPrompt getprompt(){
        ...
        BiometricPrompt.AuthenticationCallback callback = new BiometricPrompt.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded(@NonNull @NotNull BiometricPrompt.AuthenticationResult result) {
                ...
                vote.put("Category","Maintenance Team");
